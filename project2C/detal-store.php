...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Nike React Phantom Run Flyknit 2 White/黑色/Pure Platinum/白色</title>
	</head>
	...
	<body>
		...
		<div class="container4">
			<div class="piccture_zone">
				<button><img class="picture" src="555.jpg"></button>
				<button><img class="picture" src="666.jpg"></button>
				<button><img class="picture" src="777.jpg"></button>
				<button><img class="picture" src="888.jpg"></button>
				<button><img class="picture" src="999.jpg"></button>
				<button><img class="picture" src="1010.jpg"></button>
				<button><img class="picture" src="1111.jpg"></button>
				<button><img class="picture" src="1212.jpg"></button>
			</div>
			<div class="text_zone">
				<div class="name">
					<div class="name2">
						...
						<div class="container6">
							<div class="size5 css-12whm6j">
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM25" value="CJ0277-100-25">
									<label class="css-xf3ahq" for="CM25" >CM25</label>
								</div>
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM25.5" value="CJ0277-100-25A">
									<label class="css-xf3ahq" for="CM25.5" >CM25.5</label>
								</div>
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM26" value="CJ0277-100-26">
									<label class="css-xf3ahq" for="CM26" >CM26</label>
								</div>
							</div>
							<div class="size5 css-12whm6j">
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM26.5" value="CJ0277-100-26A">
									<label class="css-xf3ahq" for="CM26.5" >CM26.5</label>
								</div>
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM27" value="CJ0277-100-27">
									<label class="css-xf3ahq" for="CM27" >CM27</label>
								</div>
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM27.5" value="CJ0277-100-27A">
									<label class="css-xf3ahq" for="CM27.5" >CM27.5</label>
								</div>
							</div>
							<div class="size5 css-12whm6j">
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM28" value="CJ0277-100-28">
									<label class="css-xf3ahq" for="CM28" >CM28</label>
								</div>
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM28.5" value="CJ0277-100-28A">
									<label class="css-xf3ahq" for="CM28.5" >CM28.5</label>
								</div>
								<div class="css-181a6of">
									<input type="checkbox" name=chkbx[] id="CM29" value="CJ0277-100-29">
					...
					<div class="container6">
						<ul>
							<li>顯示顏色： True White/黑色/Pure Platinum/白色</li>
							<li>款式： CJ0277-100</li>
						</ul>
					</div>
