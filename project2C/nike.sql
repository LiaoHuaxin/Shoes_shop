...
INSERT INTO `nike` (`cID`, `cName`, `cAccount`, `cPassword`, `cSex`, `cBirthday`, `cPhone`, `cEmail`) VALUES
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `nike`
--
ALTER TABLE `nike`
  MODIFY `cID` tinyint(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
